    ...
    <>
      ...
      <section id="safety" className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-10 font-orbitron">Формат работы</h2>
          <ul className="space-y-5 mb-10">
            {[
              ...
              <li key={item} className="flex items-center gap-4 text-black text-lg">
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-12 font-orbitron text-center">Тарифы</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {/* Стандарт */}
            <div className="border border-black/10 rounded-2xl p-8 bg-white flex flex-col gap-6">
              <div>
                <p className="text-gray-500 text-sm uppercase tracking-widest mb-1 font-space-mono">Стандарт</p>
                <p className="text-black text-4xl font-bold font-orbitron">50 000 ₽</p>
              </div>
            ...
            <div className="border border-red-500/50 rounded-2xl p-8 bg-red-500/5 flex flex-col gap-6 relative">
              ...
              <div>
                <p className="text-red-500 text-sm uppercase tracking-widest mb-1 font-space-mono">VIP</p>
                <p className="text-black text-4xl font-bold font-orbitron">100 000 ₽</p>
              </div>
              <ul className="space-y-3 flex-1">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-black text-base">
