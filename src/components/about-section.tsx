    ...
    <>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-10 font-orbitron">
            ПОР<span className="text-red-500">ТАЛ</span> подойдёт вам, если вы:
          </h2>
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              <p className="text-gray-500 text-sm uppercase tracking-widest mb-5 font-space-mono">Кто вы:</p>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-black text-base leading-relaxed">
            ...
            <div>
              <p className="text-gray-500 text-sm uppercase tracking-widest mb-5 font-space-mono">И вы чувствуете:</p>
              <ul className="space-y-4">
                {[
                  "внутренний потолок",
                  ...
                  <li key={item} className="flex items-start gap-3 text-red-500 text-base leading-relaxed">
                    <span className="w-2 h-2 rounded-full bg-red-500 flex-shrink-0 mt-2" />
                    {item}
                  </li>
                ))}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ul className="space-y-5">
            {[
              ...
              <li key={item} className="flex items-start gap-4 text-black text-lg leading-relaxed">
