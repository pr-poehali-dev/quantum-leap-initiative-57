    ...
    <>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-10 font-orbitron leading-tight">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-500 text-sm uppercase tracking-widest mb-4 font-space-mono">Вроде бы:</p>
              <ul className="space-y-3">
                {["есть знания", "есть опыт", "есть развитие"].map((item) => (
                  <li key={item} className="flex items-center gap-3 text-black text-lg">
            ...
            <div>
              <p className="text-gray-500 text-sm uppercase tracking-widest mb-4 font-space-mono">Но:</p>
              <ul className="space-y-3">
                {["доход не растёт", "проявляться страшно", "повторяются одни и те же сценарии"].map((item) => (
                  <li key={item} className="flex items-center gap-3 text-red-500 text-lg">
          ...
          <p className="mt-10 text-black text-xl font-semibold border-l-4 border-red-500 pl-5">
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-500 text-base mb-6">Когда меняется внутренняя позиция человека:</p>
          ...
          <p className="text-red-500 text-lg font-space-mono border border-red-500/30 rounded-xl p-5 bg-red-500/5">
            ПОР<span className="text-red-600">ТАЛ</span> — это разрыв со старой версией себя и стабилизация нового уровня личности.
          </p>
        </div>
      </section>
    </>
